# MGraph AI Service Html Documentation

## Overview

MGraph AI Service Html will be a production-ready FastAPI microservice that provides Large Language Model (BASE) capabilities through a secure, type-safe API. 
...
```yaml
Runtime: python3.12
Handler: mgraph_ai_service_html.fast_api.lambda_handler.run
MemorySize: 512
Timeout: 30
Environment:
  Variables:

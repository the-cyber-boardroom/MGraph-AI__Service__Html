...
from mgraph_ai_service_html.html__fast_api.schemas.Schema__Dict__Operations                             import Schema__Dict__To__Html__Request, Schema__Dict__To__Text__Nodes__Request, Schema__Dict__To__Text__Nodes__Response, Schema__Dict__To__Lines__Request
...
class Routes__Dict(Fast_API__Routes):                           # Dict-based operations
    ...
    def to__text__nodes(self, request: Schema__Dict__To__Text__Nodes__Request
        ...
        return Schema__Dict__To__Text__Nodes__Response(text_nodes        = text_nodes      ,
                                                       ...
                                                       max_depth_reached = False           )  # TODO: implement depth checking

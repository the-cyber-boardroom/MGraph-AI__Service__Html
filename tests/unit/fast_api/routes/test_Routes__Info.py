...
from mgraph_ai_service_html.fast_api.routes.Routes__Info                    import Routes__Info
from mgraph_ai_service_html.service.info.schemas.Schema__Server__Versions   import Schema__Server__Versions
...
class test_Routes__Info(TestCase):
    ...
    def test_versions(self):
        with self.routes_info.versions() as _:
            ...
            assert list_set(_) == [ 'mgraph_ai_service_html'   ,
                                    'osbot_aws'                ,
                                    'osbot_fast_api'           ,
                                    'osbot_fast_api_serverless',
                                    'osbot_utils'              ]
            assert _.mgraph_ai_service_html == version__mgraph_ai_service_html

...
class test_Schema__Html__To__Tree_View__Request(TestCase):
    
    def test__init__(self):                                      # Test auto-initialization
        with Schema__Html__To__Tree_View__Request() as _:
            assert type(_) is Schema__Html__To__Tree_View__Request
    ...
    def test__with_html(self):                                   # Test with HTML content
        ...
        with Schema__Html__To__Tree_View__Request(html=html) as _:
            assert _.html  == html

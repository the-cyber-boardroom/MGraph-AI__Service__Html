...
class test_Schema__Dict__To__Tree_View__Request(TestCase):
    
    def test__init__(self):                                      # Test auto-initialization
        with Schema__Dict__To__Tree_View__Request() as _:
            assert type(_) is Schema__Dict__To__Tree_View__Request
    ...
    def test__with_html_dict(self):                              # Test with dict data
        ...
        with Schema__Dict__To__Tree_View__Request(html_dict=html_dict) as _:
            assert _.html_dict == html_dict
            assert _.obj()     == __(html_dict=__(tag='p', data='test'))

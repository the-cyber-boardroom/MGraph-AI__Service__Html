...
from mgraph_ai_service_html.config                                 import LAMBDA_DEPENDENCIES__FAST_API_SERVERLESS
from mgraph_ai_service_html.utils.Version                          import version__mgraph_ai_service_html
from mgraph_ai_service_html.utils.deploy.Deploy__Service           import Deploy__Service
